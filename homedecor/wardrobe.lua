...
homedecor.register("wardrobe", {
	...
	on_construct = function(pos)
		...
		meta:set_string("formspec", "size[5.5,8.5]"..mcl_vars.gui_bg..mcl_vars.gui_bg_img..mcl_vars.gui_slots..
	...
	on_receive_fields = function(pos, formname, fields, sender)
		...
		for i = 1,5 do
			if fields[skins[i]] then
				...
				mcl_player.player_set_textures(sender, { "homedecor_clothes_"..skins[i]..".png" })
				break
			elseif fields["fe"..skins[i]] then
				...
				mcl_player.player_set_textures(sender, { skin = "homedecor_clothes_fe"..skins[i]..".png" })
				break
			end
		end
	end
